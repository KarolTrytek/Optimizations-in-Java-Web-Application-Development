...
@Setter
@Entity
@Table(name = "wymagania_predyspozycje", schema = "ofz")
public class WymaganiaPredyspozycje implements Serializable {

	@Serial
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "wymagania_predyspozycje_id_gen")
	@SequenceGenerator(name = "wymagania_predyspozycje_id_gen", sequenceName = "seq_wymagania_predyspozycje", allocationSize = 1)
